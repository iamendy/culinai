  ...
  return (
    <section className="py-12 px-6 lg:py-16 lg:px-8">
      <div
        ...
        md:w-[50%] md:mx-auto lg:flex-row lg:items-center lg:w-[70%] lg:p-16"
      >
        <div className="relative lg:order-1 lg:flex-1">
          <Lines />
          <Image src={planning} alt="Planning meals" />
        </div>

        <div className="p-4 flex flex-col space-y-4 lg:flex-1">
